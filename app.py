...
app.config["MAIL_USERNAME"] = "WaldirBarrera"
app.config["MAIL_PASSWORD"] = "18376-01"
...
def enviaremail():
    ...
    documento=misfondos.find_one({"_id":ObjectId(id)})
    msg = Message("Fondos de pantalla Fñask", sender= "alumnocepibase.int")
    msg.recipients = [request.values.get("email")]
    msg.body = "Este es el fondo de pantalla seleccionado de nuestra galeria."
